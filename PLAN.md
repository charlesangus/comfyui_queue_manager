...
status: running
current: M6.P1.T1
pm_heartbeat: 2026-09-13T19:15:00-04:00
...
| M6 | Interactive runs preempt the queue | doing | [M6-interactive-run-preemption.md](PLAN/MILESTONES/M6-interactive-run-preemption.md) |
